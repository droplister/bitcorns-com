...
<div class="container">
    ...
    <p class="lead mb-5">Welcome to the Bitcorns API (v1). For support or to report errors, please email: <a href="mailto:bitcorncrops@gmail.com">bitcorncrops@gmail.com</a>. It's important to note that the data provided by these endpoints are specific to the Bitcorn Crops game and may show less data than the Counterparty API.</p>
    <div class="card mb-4">
        <div class="card-body">
            <h3>List Farms</h3>
