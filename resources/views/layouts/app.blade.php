    ...
    <header>
        ...
        <div class="navbar navbar-dark navbar-expand bg-dark">
            <div class="container-fluid d-flex justify-content-between">
                <a href="{{ url('/') }}" class="navbar-brand">&#x1f33d; <span class="d-none d-lg-inline">{{ config('app.name', 'Laravel') }}</span></a>
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item d-none d-sm-inline">
                            <a class="nav-link" href="{{ url(route('map')) }}">Map</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item d-none d-sm-inline">
                            <a class="nav-link" href="{{ url(route('cards.index')) }}">Cards</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="almanac_dropdown">
                                ...
                                <a class="dropdown-item d-inline-block d-sm-none" href="{{ url(route('map')) }}">World Map</a>
                                <a class="dropdown-item d-inline-block d-sm-none" href="{{ url(route('cards.index')) }}">Game Cards</a>
                                <a class="dropdown-item d-inline-block d-sm-none" href="{{ url('/rules') }}">Game Rules</a>
                                <a class="dropdown-item d-inline-block d-sm-none" href="{{ url(route('tokens.index')) }}">Game Tokens</a>
    ...
    <footer class="text-muted">
        <div class="container">
            ...
            <p>
                ...
                <a href="{{ url('/terms') }}" class="mr-3">Terms</a>
